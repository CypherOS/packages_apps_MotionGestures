...
public class FlipToMute implements UpdatedStateNotifier {
    private static final String TAG = "Motion-FlipToMute";
    ...
    public FlipToMute(MotionSettings motionSettings, Context context,
    ...
    public void updateState() {
        if (mMotionSettings.isFlipToMuteEnabled() && !mIsEnabled) {
            Log.d(TAG, "Enabling");
            ...
            mIsEnabled = true;
        } else if (!mMotionSettings.isFlipToMuteEnabled() && mIsEnabled) {
            Log.d(TAG, "Disabling");
