...
public class StowSensor implements ScreenStateNotifier, SensorEventListener {
    private static final String TAG = "Motion-StowSensor";
    ...
    public StowSensor(MotionSettings motionSettings, SensorHelper sensorHelper,
                SensorAction action) {
    ...
    public void screenTurnedOff() {
        if (!mMotionSettings.isIrWakeupEnabled() &&
            mMotionSettings.isPickUpEnabled() && !mEnabled) {
            Log.d(TAG, "Enabling");
