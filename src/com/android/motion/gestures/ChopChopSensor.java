...
public class ChopChopSensor implements SensorEventListener, UpdatedStateNotifier {
    private static final String TAG = "Motion-ChopChopSensor";
    ...
    public ChopChopSensor(MotionSettings motionSettings, SensorHelper sensorHelper) {
    ...
    public synchronized void updateState() {
        if (mMotionSettings.isChopChopGestureEnabled() && !mIsEnabled) {
            Log.d(TAG, "Enabling");
            mSensorHelper.registerListener(mSensor, this);
            mSensorHelper.registerListener(mProx, mProxListener);
            mIsEnabled = true;
        } else if (! mMotionSettings.isChopChopGestureEnabled() && mIsEnabled) {
            Log.d(TAG, "Disabling");
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        mMotionSettings.chopChopAction();
    }
