...
public class LiftToSilence extends PhoneStateListener implements SensorEventListener, UpdatedStateNotifier {
    private static final String TAG = "Motion-LiftToSilence";
    ...
    public LiftToSilence(MotionSettings motionSettings, Context context,
    ...
    public void updateState() {
        if (mMotionSettings.isLiftToSilenceEnabled()) {
