...
public class MotionGesturesFragment extends PreferenceFragment {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        addPreferencesFromResource(R.xml.motion_gestures);
        PreferenceCategory ambientDisplayCat = (PreferenceCategory)
                findPreference(CATEGORY_AMBIENT_DISPLAY);
        if (ambientDisplayCat != null) {
            ambientDisplayCat.setEnabled(MotionSettings.isDozeEnabled(getActivity().getContentResolver()));
        }
        if (Device.isSurnia()){
