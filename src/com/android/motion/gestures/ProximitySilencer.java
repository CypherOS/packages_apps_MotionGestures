...
public class ProximitySilencer extends PhoneStateListener implements SensorEventListener, UpdatedStateNotifier {
    private static final String TAG = "Motion-ProximitySilencer";
    ...
    public ProximitySilencer(MotionSettings motionSettings, Context context,
    ...
    public void updateState() {
        if (mMotionSettings.isIrSilencerEnabled()) {
