...
public class FlatUpSensor implements ScreenStateNotifier {
    private static final String TAG = "Motion-FlatUpSensor";
    ...
    public FlatUpSensor(MotionSettings motionSettings, SensorHelper sensorHelper,
                SensorAction action) {
    ...
    public void screenTurnedOff() {
        if (mMotionSettings.isPickUpEnabled() && !mEnabled) {
            Log.d(TAG, "Enabling");
